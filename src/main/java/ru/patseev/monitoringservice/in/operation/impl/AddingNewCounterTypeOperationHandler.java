...
public class AddingNewCounterTypeOperationHandler implements OperationHandler {
	...
	public void handleRequest(HttpServletRequest req, HttpServletResponse resp) {
		...
		responseGenerator.generateResponse(resp, HttpServletResponse.SC_OK, "New data meter saved");
	}
}
